...
public class EnchantersGatling extends GatlingItem implements ICasterTool, ISpellModifierItem {
    StatsModifier statsModifier;
    boolean creativeOnly = false;

    public EnchantersGatling(Properties properties, int bonusDamage, double damageMultiplier, int fireDelay, double inaccuracy, int enchantability, float spellCostMultiplier) {
        super(properties, bonusDamage, damageMultiplier, fireDelay, inaccuracy, enchantability);
        this.statsModifier = new StatsModifier(spellCostMultiplier);
    }
    public EnchantersGatling(Properties properties, int bonusDamage, double damageMultiplier, int fireDelay, double inaccuracy, int enchantability, StatsModifier statsModifier) {
        super(properties, bonusDamage, damageMultiplier, fireDelay, inaccuracy, enchantability);
        this.statsModifier = new StatsModifier(statsModifier);
    }

    public EnchantersGatling setCreative(){
        creativeOnly = true;
        return this;
    }
